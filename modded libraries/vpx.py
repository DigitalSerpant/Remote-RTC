...
def number_of_threads(pixels: int, cpus: int) -> int:
    if pixels >= 1920 * 1080 and cpus > 12:
        return 12
...
class Vp8Encoder(Encoder):
    ...
    def __update_config(self) -> None:
        ...
        self.cfg.g_threads = number_of_threads(
            self.cfg.g_w * self.cfg.g_h, multiprocessing.cpu_count()
        )
        self.cfg.rc_end_usage = lib.VPX_VBR
        self.cfg.rc_min_quantizer = 2
        self.cfg.rc_max_quantizer = 50
        self.cfg.rc_undershoot_pct = 25
        self.cfg.rc_overshoot_pct = 25
        self.cfg.rc_buf_initial_sz = 1000
        self.cfg.rc_buf_optimal_sz = 1500
        self.cfg.rc_buf_sz = 2000
        self.cfg.kf_max_dist = 60
        self.cfg.g_timebase.num = 1
        self.cfg.g_timebase.den = VIDEO_CLOCK_RATE
        self.cfg.kf_mode = lib.VPX_KF_AUTO
